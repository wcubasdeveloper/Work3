...
exports.imprimirCATS = function(req, res, funcionName){ // Esta opcion es llamada en el boton IMPRIMIR de la ventana de Registros de Contratos
    ...
    var queryInsertRenovacion = "Insert into Contrato_Renovacion(idContrato, nroCuota, idEmpresaTransp, fechaRenovacion, flotaActual, totalCuota, estado) values (?,?,?,?,?,?,'I')";
...
exports.guardarRenovacion = function(req, res, funcionName){
    ...
    var queryInsert = "Insert into Contrato_Renovacion(idContrato, nroCuota, idEmpresaTransp, fechaRenovacion, flotaActual, totalCuota) values (?,?,?,?,?,?)";
    var parametros = [idContrato, nroCuota, idEmpresaTransp, fechaRenovacion, flotaActual, totalCuota]
...
exports.imprimirCuota = function(req, res, funcionName){
    ...
    ejecutarQUERY_MYSQL(updateEstadoRenovacion, parametros, res, funcionName, "affectedRows") // devuelve al cliente la cantidad de filas afectadas
}
