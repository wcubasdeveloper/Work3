	...
	switch (tipoCarta) {
		case '1': // carta de garantia de gastos
			...
			var body =
				...
				"<img src='" + urldominio + "wpimages/logo_autoseguro.jpg' style='width:260px;'/>" +
				"</div>" +
				...
				"<col style='width:50%'>" +
				"<tr>" +
				"<td style='text-align:right; font-size:14px; font-weight:bold;'>F. de Accidente: </td>" +
				"<td style='font-size:14px;'>" + fechaOcurrencia + "</td>" +
				"</tr>" +
				"<tr>" +
				"<td style='text-align:right; font-size:14px; font-weight:bold;'>Cod Evento: </td>" +
				"<td style='font-size:14px;'>" + codEvento + "</td>" +
				"</tr>" +
				"<tr>" +
				"<td style='text-align:right; font-size:14px; font-weight:bold;'>Nro Siniestro: </td>" +
				...
				"<col style='width:90%'>" +
				"<tr style='height:13px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>Señor(es):</td>" +
				"<td style='text-align:left; font-size:14px;'>" + nosocomio_funeraria + "</td>" +
				"</tr>" +
				"</table>" +
				"<br>" +
				"<table style='width:" + ancho + "; margin:auto; font-style:" + font + ";' >" +
				...
				"<td colspan='4' style='text-align:left; font-weight:bold; font-size:14px;'>Referencia del Siniestro: </td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>F. de Atención: </td>" +
				"<td style='text-align:left; font-size:14px;'>" + fechaAtencion + "</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>Placa: </td>" +
				"<td style='text-align:left; font-size:14px;'>" + placa + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px;'>Nro CAT: </td>" +
				"<td style='text-align:left; font-size:14px;'>" + cat + "</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>Asegurado: </td>" +
				"<td style='text-align:left; font-size:14px;'>" + asociado + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>Especialidad: </td>" +
				"<td style='text-align:left; font-size:14px;'>" + servicioMedico + "</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>Paciente: </td>" +
				"<td style='text-align:left; font-size:14px;'>" + paciente + "</td>" +
				"</tr>" +
				"</table>" +
				"<br>" +
				"<table style='width:" + ancho + "; margin:auto; font-style:" + font + ";' >" +
				...
				"<col style='width:71%'>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px; padding-left: 16px;'>Diagnóstico Inicial</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>:</td>" +
				"<td style='text-align:left; font-size:14px;'>" + diagnosticoAccidente + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px; padding-left: 16px;'>Diagnóstico Final</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>:</td>" +
				"<td style='text-align:left; font-size:14px;'>" + diagnostico + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px; padding-left: 16px;'>Observaciones</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:14px;'>:</td>" +
				"<td style='text-align:left; font-size:14px;'>" + observaciones + "</td>" +
				"</tr>" +
				"</table>" +
				"<br>" +
				"<div id='cuerpo' style='width:" + ancho + "; margin:auto;'>" +
				...
				"<table style='width:" + ancho + "; margin:auto; font-style:" + font + "; font-size:14px;' border=1>" +
				"<col style='width:33%'>" +
				"<col style='width:33%'>" +
				"<col style='width:34%'>" +
				...
				"</tr>" +
				"</table>" +
				"<p style='text-align:justify; font-size:14px; line-height:18.5px; padding-top:7px; font-weight:bold;'>" +
