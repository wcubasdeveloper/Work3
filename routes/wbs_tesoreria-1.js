...
exports.imprimirOPA = function (req, res, funcionName) {
    ...
    ejecutarQUERY_MYSQL(queryDetalleOrden, params, res, funcionName, function (res, results) {
        if (results.length > 0) {
            ...
            var footer = "<div id ='footer' style='margin:auto; font-family:Arial; width:" + $ancho + "; text-align:justify; margin-top:5px;'>" +
                "<table style='width:600px; font-size:9px;'>" +
                "<col style='width:31%'>" +
                "<col style='width:2%'>" +
                "<col style='width:67%'>" +
                "<tr>" +
            ...
            var body = "<html>" +
                ...
                "<div style='font-size:15px; font-weight:bold; text-align:center; margin-top:15px;'>" +
                "ORDEN DE PAGO N° " + nroOrdenPagoAgraviado +
                "</div>" +
                "<div style='font-size:15px; font-weight:bold; text-align:center; margin-top:0px;'>" +
                detallesExpediente[tipoExpediente].subTitulo +
                "</div>" +
                "<div style='font-size:15px; font-weight:bold; text-align:center; margin-top:0px;'>" +
                "AUTOSEGURO AFOCAT" +
                "</div><br>" +
                "<div id='cabecera1' style='width:" + $ancho + "; font-size:12px; margin-top:0px;'>" +
                ...
                "</div>" +
                "<br>" +
                "<div id='fechaImpresion' style='font-size:12px; text-align:right;' >" +
                $fechaImpresion +
                "</div>" +
                "</div>" +
                "</body>" +
