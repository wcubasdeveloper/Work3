	...
	switch (tipoCarta) {
		case '1': // carta de garantia de gastos
			...
			var body =
				...
				"<col style='width:71%'>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:10px; padding-left: 16px;'>Diagnóstico Inicial</td>" +
				...
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:10px; padding-left: 16px;'>Diagnóstico Final</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:10px;'>:</td>" +
				"<td style='text-align:left; font-size:10px;'>" + diagnostico + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:10px; padding-left: 16px;'>Observaciones</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:10px;'>:</td>" +
				"<td style='text-align:left; font-size:10px;'>" + observaciones + "</td>" +
				"</tr>" +
				"</table>" +
				"<br>" +
				"<div id='cuerpo' style='width:" + ancho + "; margin:auto;'>" +
		...
		case '2': // carta de garantia por sepelio
			...
			body =
				"<div style='width:" + ancho + "; font-family:arial; font-size:10px; background-color:; min-height:40px; font-style:" + font + ";'>" +
				"<table id='datos_impresion' style='float:right; width:250px; color:gray; font-size:9px; background-color:;'>" +
				"<col style='width:43%'>" +
				"<col style='width:2%'>" +
				"<col style='width:55%'>" +
		...
		ejecutarQUERY_MYSQL_Extra(resultados, queryAgraviados, arrayParametrosAgraviados, res, funcionName, function (res, rowsAgraviados, resultados) {
			...
			ejecutarQUERY_MYSQL_Extra(resultados, queryVehiculos, arrayParams, res, funcionName, function (res, rowsVehiculos, resultados) {
				...
				var tablaAgraviados = '<table border="1" id="tabla_agraviados" width="100%" style="font-size:9px;">' +
					'<thead>' +
					'  <tr style="color:white; background-color:#4485A6; font-size:9px; height:25px;">' +
