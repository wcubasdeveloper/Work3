	...
	switch (tipoCarta) {
		case '1': // carta de garantia de gastos
			...
			var body =
				...
				"<col style='width:50%'>" +
				"<tr>" +
				"<td style='text-align:right; font-size:10px; font-weight:bold;'>F. de Accidente: </td>" +
				"<td>" + fechaOcurrencia + "</td>" +
				"</tr>" +
				"<tr>" +
				"<td style='text-align:right; font-size:10px; font-weight:bold;'>Cod Evento: </td>" +
				"<td>" + codEvento + "</td>" +
				"</tr>" +
				"<tr>" +
				"<td style='text-align:right; font-size:10px; font-weight:bold;'>Nro Siniestro: </td>" +
				"<td>" + codAgraviado + "</td>" +
				"</tr>" +
				"</table>" +
				"</div>" +
				...
				"<td colspan='4' style='text-align:left; font-weight:bold; font-size:10px;'>Referencia del Siniestro: </td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				...
				"<col style='width:71%'>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px; padding-left: 16px;'>Diagnóstico Inicial</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px;'>:</td>" +
				"<td style='text-align:left; font-size:10px;'>" + diagnosticoAccidente + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px; padding-left: 16px;'>Diagnóstico Final</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px;'>:</td>" +
				"<td style='text-align:left; font-size:10px;'>" + diagnostico + "</td>" +
				"</tr>" +
				"<tr style='height:18px;'>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px; padding-left: 16px;'>Observaciones</td>" +
				"<td style='text-align:left; font-weight:bold; font-size:12px;'>:</td>" +
				"<td style='text-align:left; font-size:12px;'>" + observaciones + "</td>" +
				"</tr>" +
				"</table>" +
				"<br>" +
				"<div id='cuerpo' style='width:" + ancho + "; margin:auto;'>" +
