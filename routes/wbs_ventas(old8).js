...
function getInfoContrato(req, res, funcionName, callback){
    ...
    var query = "select idContrato, date_format(fechaEmision, '%d/%m/%Y') as fechaEmision,"+
        ...
        " date_format(fechaVigenciaCert, '%d/%m/%Y') as fechaVigenciaCert, date_format((select crn.fechaRenovacion from Contrato_Renovacion crn where crn.idContrato=? and crn.nroCuota=?), '%d/%m/%Y') as fechaRenovacion, "+
    ...
    var parametros = [idContrato, nroCuota, idContrato]
    ...
    ejecutarQUERY_MYSQL(query, parametros, res, funcionName, function(res, resultados){
        ...
        if(resultados.length>0){
            ...
            var queryCertificadosFlota = "Select c.idContratoCertificado, c.nroOrden, "+
                ...
                " u.idUso, u.nombreUso, ucv.idUsoClaseVehiculo as idClase, cv.nombreClase as clase, (select count(*) from Contrato_Certificados cc where cc.idVehiculo = c.idVehiculo and cc.nroCertificado is not null and cc.idContrato=?) as cantidadDeUsoVehiculo "+
            ...
            var idContrato = req.query.idContrato;
            var params = [idContrato, idContrato, nroCuota]
...
exports.reporteContratoExcel = function(req, res, funcionName){
    getInfoContrato(req, res, "getInfoContrato", function(results){
        ...
        // ** obtiene la fecha de Fin de la vigencia del certificado **
		results.fechaVigenciaCert=results.fechaRenovacion
