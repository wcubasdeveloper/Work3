  ...
  pool.getConnection(function(err,connection){
    if (err) {
      ...
      connection.release();
        ...
        var query ="SELECT u.Nombres, u.Apellidos, u.password, u.idUsuario, u.idPerfil1, u.idPerfil2, u.idPerfil3,  u.idArea, a.Nombre as nombreArea, a.plantilla, u.horaActualizacion, "+
