var urldominio = "https://sistema.autoseguro.pe/";
...
var nivelDebug = 3; // 0=No muestra nada; 1=Muestra solo erorres; 2=Muestra solo avisos; 3=Muestra errores mas avisos
...
var executePDF = function executePDF($titulo, $idAcuerdo, $fechaAcuerdo, $deudaAcuerdo, $codEvento, $fechaEvento, $descripcionEvento, $cabecera3, $parteUltima, res) {
    ...
    var html = "<html>" +
        ...
        "<br>" +
        "<div id='Titulo' style='font-size:17px; font-weight:bold;'>" +
        $titulo +
        "</div>" +
        "<img src='" + urldominio + "images/autoseguro.jpg' style='width:150px; height:60px;  float:right; margin-top:-46px;'>" +
        "<br>" +
        "<div style='height:75px; margin-top:30px;'>" +
        ...
        "</tr>" +
        "</table>" +
        "<table style='width:295px; float:right;'>" +
        "<col style='width:40%'>" +
        "<col style='width:60%'>" +
        "<tr style='font-size:9.5px; vertical-align:middle;'>" +
