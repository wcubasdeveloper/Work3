        ...
        switch(accion){
            case 'N':
                for(var i=0; i<data.length; i++){
                    ...
                    data[i].html_borrar= "<a onclick='borrar(this, "+'"'+data[i].codAgraviado+'"'+")' style='cursor: pointer; text-decoration: none; font-size:11px;'>Borrar</a>";
                }
               break;
            case 'E':
                for(var i=0; i<data.length; i++){
...
function agregarAgraviado(){
    try{
        ...
        var trAgraviado="<tr style='font-family: Arial; height: 30px; cursor: pointer; font-size: 12px;'>" +
            ...
            "<td style='text-align: center;'><a onclick='borrar(this)' style='cursor: pointer; text-decoration: none; font-size:11px;'>Borrar</a></td>";
        "</tr>";
		...
		if(typeof lista_Vehiculos !='undefined' ){
			if(lista_Vehiculos.length>0){
				for(var i=0; i<lista_Vehiculos.length; i++){
					...
					lista_Vehiculos[i].html_borrar = "<a onclick='borrarVehiculo(this, "+'"'+lista_Vehiculos[i].idVehiculoInformado+'"'+")' style='cursor: pointer; text-decoration: none; font-size:12px;'>Borrar</a>";
				}
				var camposAmostrar = [ // asigna los campos a mostrar en la grilla
...
function agregarVehiculo(){
	try{
        $("#tabla_vehiculos > tbody").append("<tr style='font-family: Arial; height: 20px; font-size:11px;'>" +
            ...
            "<td style='text-align: center;'><input type='text' style='width: 90px; font-size:12px; text-align:center;'/></td>"+
            "<td style='text-align: center;'><input type='text' style='width: 90px; font-size:12px; text-align:center;'/></td>"+
            "<td style='text-align: center;'><a onclick='borrarVehiculo(this)' style='cursor: pointer; text-decoration: none; font-size:12px;'>Borrar</a> </td>"+
            "</tr>");
	}catch(err){
