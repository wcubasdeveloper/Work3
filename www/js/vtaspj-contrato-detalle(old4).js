 ...
 function impresionCATS(){
     try{
         fancyConfirm("¿Esta seguro de proceder con la operación?", function(rpta){
             if(rpta){
                 var fechaRenovacion = dateTimeFormat($("#txtVigCert_Fin").val())
                 ...
                 detalleContrato[0].fechaInicio=dateTimeFormat($("#txtVigCert_Inicio").val())
                 detalleContrato[0].fechaCaducidad=dateTimeFormat($("#txtVigCert_Fin").val())
