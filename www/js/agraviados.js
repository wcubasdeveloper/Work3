...
/* @ListarAgraviados: Abre la ventana que lista los agraviados  del evento seleccionado.
*/
function ListarAgraviados(){
	try{
		if(filaSeleccionada==undefined){
			fancyAlert("Por favor seleccione un evento");
		}else{
			abrirFancyBox(950, 450, "listaragraviados", true);		
		}
	}catch(err){
		emitirErrorCatch(err, "ListarAgraviados"); // emite error
	}
}
