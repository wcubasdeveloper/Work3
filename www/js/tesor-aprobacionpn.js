/*Interface que permite revisar un voucher previamente ingresado y Anularlo o Aprobarlo,
...
function anularVoucher(){
	try{
		if(filaSeleccionada==undefined){
            ...
            if(arrayDatos[filaSeleccionada].estado != 'PEND'){
                ...
                parent.abrirVentanaFancyBox(1100, 750,
                        "tesor-aprobacionpn-voucher?accion=A&idDepositoPN=" + arrayDatos[filaSeleccionada].idDeposito, true,
                    function () {
                        buscar();
                    },
                    true);
		...
		emitirErrorCatch(err, "anularVoucherPN");
	}
}
    ...
    try{
        if(filaSeleccionada==undefined){
           ...
           if(arrayDatos[filaSeleccionada].estado != 'PEND'){
                ...
                parent.abrirVentanaFancyBox(1100, 750,
                        "tesor-aprobacionpn-voucher?accion=B&idDepositoPN="+arrayDatos[filaSeleccionada].idDeposito, true,
                    function(){
                        buscar();
                    },
                    true);
        ...
        emitirErrorCatch(err, "aprobarVoucherPN");
    }
}
