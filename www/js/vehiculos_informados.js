...
/* @ListarVehiculos: Abre la ventana que lista los vehículos informados del evento seleccionado.
*/
function ListarVehiculos(){
	try{
		if(filaSeleccionada==undefined){
			...
			abrirFancyBox(950, 450, "listarvehiculos", true);		
		}
	}catch(err){
		emitirErrorCatch(err, "ListarVehiculos"); // emite error
	}
}
