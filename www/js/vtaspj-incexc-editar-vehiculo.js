...
cargarInicio(function(){
    $("#btnGuardar").click(incluir_excluir);
...
function incluir_excluir(){
    try{
        if(idDetalle!=undefined){ // exclusion
            var vehiculo = parent.arrayDatos[idDetalle];
            vehiculo.estado='E'
            realizoTarea=true;
            rptaCallback = vehiculo;
        ...
        emitirErrorCatch(err, "incluir_excluir")
    }
}
